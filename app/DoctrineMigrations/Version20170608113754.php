 ...
 */
class Version20170608113754 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE genus ADD first_discoverd_at DATETIME NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE genus DROP first_discoverd_at');
    }
}
