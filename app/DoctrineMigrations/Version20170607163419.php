 ...
 */
class Version20170607163419 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE genus ADD sub_family_id INT NOT NULL, DROP sub_family, DROP notes');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE genus ADD sub_family VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, ADD notes VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, DROP sub_family_id');
    }
}
